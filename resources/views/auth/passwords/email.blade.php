...
<div class="forgot-wrapper">
  ...
  <div class="forgot-visual">
    <img
      ...
      alt="DERU Collection"
      class="forgot-visual-img"
    >
    <div class="forgot-visual-overlay"></div>
    <div class="forgot-visual-content">
      ...
      <div class="forgot-visual-quote">
        <p style="font-family:'Cormorant Garamond',serif; font-size:2.2rem; font-weight:400; font-style:italic; color:white; line-height:1.3; margin-bottom:1.5rem;">
          "Even the extraordinary forget things sometimes."
        </p>
  ...
  <div class="forgot-form-panel">
    <div class="forgot-form-inner">
      ...
      @if (session('status'))
        <div class="deru-alert-success mb-4">
      ...
      <form method="POST" action="{{ route('password.email') }}">
        ...
        {{-- Submit --}}
        <div style="animation: fadeUp 0.6s ease 0.4s both; margin-top: 20px;">
